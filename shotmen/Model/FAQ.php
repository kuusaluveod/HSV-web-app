...
class FAQ
{
    ...
    function getFAQ() 
    {
        $query = "SELECT id, fname, lname, throw1, throw2, throw3, throw4, throw5, throw6, result1, sex, event FROM compdata WHERE event = 'SHOT' AND sex = 'M' ORDER BY result1 DESC, result2 DESC, result3 DESC";
